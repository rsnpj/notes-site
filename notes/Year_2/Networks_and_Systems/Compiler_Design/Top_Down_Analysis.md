...
<Definition name="LL(1) Grammar">
    ...
    <ul>
        <li> There is no terminal a such that both $\alpha$ and $\beta$ derive a string starting with a</li>
        <li> At most one of $\alpha$ and $\beta$ can derive the empty string $\epsilon$</li>
        <li> If $\beta \Rightarrow \epsilon$ then $\alpha$ does not derive any string beginning with a terminal in FOLLOW(A) and vice versa</li>
    </ul>
</Definition>
