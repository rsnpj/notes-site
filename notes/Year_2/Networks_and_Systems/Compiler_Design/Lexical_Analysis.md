...
![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/context-free-grammar.png)
...
![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/regular_definitions.png)
...
![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/attribute_value.png)
...
![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/transition_diagram.png)
...
- Usually we look for identifier lexemes with a transition diagram
  ...
  ![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/lexemes.png)
...
2.  Create separate transition diagrams for each reserved word, example
    ...
    ![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/reserved_word.png)
...
![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/recognise.png)

It composes a single equivalent NFA that recognises all of them

![image](/img/Year_2/Networks_and_Systems/Compiler_Design/Lexical_Analysis/combined.png)
