...
export default function Theorem(props) {
  ...
  return (
    <div className="bg-clip-border bg-gradient-to-r from-orange-300 via-green-300 to-purple-300 py-1 rounded">
      <div className="bg-white p-4 m-2">
        <span className="block text-2xl font-semibold text-black">
          Theorem {props.name ? "- " + props.name : ""}
        </span>
        <div className="italic" dangerouslySetInnerHTML={{ __html: theorem }} />
      </div>
    </div>
  );
}
